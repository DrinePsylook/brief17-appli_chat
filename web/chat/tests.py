...
class ChatTests(ChannelsLiveServerTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls._test_instance = cls(methodName='setUpClass')
        cls._test_instance._pre_setup()
        ...
        try:
            ...
            print(f"❌ Échec du lancement de Chrome : {e}")
            cls.tearDownClass()
            raise
    ...
    def tearDownClass(cls):
        if hasattr(cls, "driver"):
            cls.driver.quit()
        cls._test_instance._post_teardown()
    ...
    def _enter_chat_room(self, room_name):
        ...
        input_box = self.driver.find_element(By.ID, "room-name-input")
        input_box.send_keys(room_name)
        submit_button = self.driver.find_element(By.ID, "room-name-submit")
        submit_button.click()
